...
extension CoinAction {
    ...
    static var swapChains: [Chain] = [
        ...
        .thorChain, .thorChainStagenet, .thorChainStagenet2, .mayaChain, .ethereum, .avalanche, .base, .arbitrum, .blast, .mantle, .hyperliquid,
        .polygon, .polygonV2, .optimism, .bscChain, .gaiaChain, .kujira, .zksync, .zcash, .ripple,
        .cronosChain, .tron
    ]

    static var memoChains: [Chain] = [
        .thorChain, .thorChainStagenet, .thorChainStagenet2, .mayaChain, .ton, .dydx, .kujira, .gaiaChain, .osmosis,
