...
struct EvmServiceConfig {
    ...
    enum TokenProvider {
        ...
        func getTokens(nativeToken: Coin, rpcActor: RpcServiceActor) async -> [CoinMeta] {
            switch self {
            case .standard:
                return await EvmServiceStruct.getTokensStandard(nativeToken: nativeToken, rpcActor: rpcActor)
