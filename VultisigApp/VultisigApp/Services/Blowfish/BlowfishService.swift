...
struct BlowfishService {
    ...
    func blowfishChainName(chain: Chain) throws -> String {
        ...
        case .solana:
            return "solana"
        case .thorChain, .bitcoin, .bitcoinCash, .litecoin, .dogecoin, .dash, .gaiaChain, .kujira, .mayaChain, .cronosChain, .sui, .polkadot, .zksync, .dydx, .ton, .osmosis, .terra, .terraClassic, .noble, .ripple, .akash, .tron:
