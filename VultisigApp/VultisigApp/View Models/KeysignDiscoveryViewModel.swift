...
class KeysignDiscoveryViewModel: ObservableObject {
    ...
    init() {
        ...
        self.keysignPayload = KeysignPayload(coin: Coin.example.toCoinMeta(), toAddress: "", toAmount: 0, chainSpecific: BlockChainSpecific.UTXO(byteFee: 0, sendMaxAmount: false), utxos: [], memo: nil, swapPayload: nil, approvePayload: nil, vaultPubKeyECDSA: vault.pubKeyECDSA, vaultLocalPartyID: vault.localPartyID)
