...
struct ChainIconView: View {
    ...
    var body: some View {
        // Full-color brand logos carry their own margins, so they get a
        // slightly tighter inset than the retired mono glyphs needed to
        // occupy the same visual space on the white disc.
        Image(icon)
            .resizable()
