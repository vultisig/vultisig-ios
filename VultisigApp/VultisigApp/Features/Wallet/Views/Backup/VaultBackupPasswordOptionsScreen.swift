...
struct VaultBackupPasswordOptionsScreen: View {
    ...
    var textContent: some View {
        VStack(spacing: 16) {
            ...
            boxedText("backupOptionsBox1".localized, highlighted: "backupOptionsBox1Highlighted".localized, icon: .lockKeyholeOpen)

            boxedText("backupOptionsBox2".localized, highlighted: "backupOptionsBox2Highlighted".localized, icon: .folderLock)

            boxedText("backupOptionsBox3".localized, highlighted: "backupOptionsBox3Highlighted".localized, icon: .fileWarning)
        }
    }
