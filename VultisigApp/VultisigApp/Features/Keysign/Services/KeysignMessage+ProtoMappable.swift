...
extension KeysignMessage: ProtoMappable {
    ...
    init(proto: VSKeysignMessage) throws {
        ...
        self.customPayloadID = proto.hasCustomPayloadID ? proto.customPayloadID : ""
    }
    ...
    func mapToProtobuff() -> VSKeysignMessage {
        let message = VSKeysignMessage.with {
            ...
            if !customPayloadID.isEmpty {
                $0.customPayloadID = customPayloadID
            }
            ...
            self = .generic(GenericSwapPayload(
                ...
                quote: EVMQuote(
                    ...
                    tx: EVMQuote.Transaction(
                        ...
                        swapFee: value.quote.tx.swapFee.nilIfEmpty,
            ...
            return .oneinchSwapPayload(.with {
                ...
                $0.quote = .with {
                    ...
                    $0.tx = .with {
                        ...
                        if let swapFee = payload.quote.tx.swapFee {
                            $0.swapFee = swapFee
