...
//  VultisigApp
//
//  Strict human-decimal parsing for the SWITCH amount.
//
...
//  as fifteen in `de_DE`. SWITCH attaches a real transfer of the chain's native
//  asset, so a reinterpreted separator is a ten-times send from a paste.
//
