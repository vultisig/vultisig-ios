 ...
 */
mldsa_lib_error mldsa_keygen_setupmsg_new(uint32_t threshold,
 ...
 */
mldsa_lib_error mldsa_keygen_session_from_setup(const struct go_slice *setup,
 ...
 */
mldsa_lib_error mldsa_sign_setupmsg_new(const struct go_slice *key_id,
 ...
 */
mldsa_lib_error mldsa_sign_session_from_setup(const struct go_slice *setup,
                                              const struct go_slice *id,
                                              struct Handle share,
                                              struct Handle *hnd);
