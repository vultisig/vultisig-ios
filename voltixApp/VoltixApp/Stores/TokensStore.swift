...
class TokensStore {
    static var TokenSelectionAssets = [
        ...
        Coin(chain: Chain.BSCChain, ticker: "BNB", logo: "bsc", address: "", priceRate: 0.0, chainType: ChainType.EVM, decimals: "18", hexPublicKey: "", feeUnit: "Gwei", priceProviderId: "bnb", contractAddress: "", rawBalance: "0", isNativeToken: true, feeDefault: "21000"),
    ]
