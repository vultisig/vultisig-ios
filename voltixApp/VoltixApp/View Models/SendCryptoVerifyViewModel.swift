        ...
        if tx.coin.chain.chainType == ChainType.UTXO {
            ...
            if tx.coin.isNativeToken {
                let keysignPayload = KeysignPayload(
                    ...
                    chainSpecific: BlockChainSpecific.Ethereum(maxFeePerGasGwei: Int64(tx.gas) ?? 24, priorityFeeGwei: 0, nonce: tx.nonce, gasLimit: EVMHelper.defaultETHTransferGasUnit),
                    utxos: [],
                    memo: nil,
                    swapPayload: nil
                )
                ...
                let keysignPayload = KeysignPayload(
                    ...
                    chainSpecific: BlockChainSpecific.ERC20(maxFeePerGasGwei: Int64(tx.gas) ?? 42, priorityFeeGwei: 0, nonce: tx.nonce, gasLimit: EVMHelper.defaultERC20TransferGasUnit, contractAddr: tx.coin.contractAddress),
                    utxos: [],
                    memo: nil,
                    swapPayload: nil
                )
