...
class KeysignDiscoveryViewModel: ObservableObject {
    ...
    init() {
        ...
        self.keysignPayload = KeysignPayload(coin: Coin.example, toAddress: "", toAmount: 0, chainSpecific: BlockChainSpecific.UTXO(byteFee: 0), utxos: [], memo: nil, swapPayload: nil, vaultPubKeyECDSA: vault.pubKeyECDSA)
